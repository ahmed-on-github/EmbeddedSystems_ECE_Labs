...
FINAL_IMAGE=${DISTDIR}/GccApplication1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/GccApplication1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${DISTDIR}/GccApplication1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\avr-objcopy -O ihex "${DISTDIR}/GccApplication1.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}" "${DISTDIR}/GccApplication1.X.${IMAGE_TYPE}.hex"
